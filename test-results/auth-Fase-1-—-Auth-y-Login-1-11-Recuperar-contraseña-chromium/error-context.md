...
- Name: auth.spec.ts >> Fase 1 — Auth y Login >> 1.11 Recuperar contraseña
- Location: e2e\auth.spec.ts:112:3
...
Locator: getByText('Te enviamos un email para restablecer tu contraseña.')
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for getByText('Te enviamos un email para restablecer tu contraseña.')
...
- textbox "Contraseña (mín. 6 caracteres)"
- paragraph: Error al enviar el correo de recuperación. Inténtalo de nuevo más tarde.
- paragraph: Ingresa tu email y te enviaremos un enlace para restablecer tu contraseña.
